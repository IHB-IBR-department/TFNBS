...
Train on IHB, test on RMET. Edge masks are derived from saved p-maps.

Usage:
  python -m examples.openclose_ml_transfer_from_pvals \\
...
from examples.openclose_loader import OpenCloseDataset
from examples.ml_validation import build_ml_dataset, mask_to_feature_indices
